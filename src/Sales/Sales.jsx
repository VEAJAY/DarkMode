    ...
    <>
      <div className="sales-screen">
        <div className="item-list">
          <div className="item">
            <p>(1) Item Description: Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="item">
            <p>(2) Item Description: Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="item">
            <p>(3) Item Description: Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="item">
            <p>(4) Item Description: Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="item">
            <p>(5) Item Description: Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="item">
            <p>(6) Item Description: Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
