  ...
  return (
    <div>
      <ul className='help-list'>
        <li>
          <p>
            1.4 - <span className='title'>Sales:</span> Checkout screen for totaling transactions. Please set the load indicators for correct use: CW(carry with), NL(not loaded), PL(pickup later), LD(lowes delivery).SOE and WEX orders are NOT available in Dark Mode. Use Manual Order in MRV and transmit PO to vendor
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            3.4 - <span className='title'>Journals:</span> View receipt jopurnals within the last 3 months, transaction accounts in cash, check and credit accounts. DL numbers are exposed only through Journals screen. Use 24:00 time to spool receipt journals to 9.5
          </p>
        </li>
        <li>
          <p>
